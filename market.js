...
// Registrar clientes
sup.registerClient(cliente1);
sup.registerClient(cliente2);
sup.registerClient(cliente3);

// Enviar notificaciones
sup.notifyClients("Descuento del 30% en frutas y verduras");
sup.notifyClients("Oferta especial: 2x1 en productos de aseo");

// Desuscribir un cliente y enviar una nueva oferta
sup.unsubscribeClient(cliente2);
sup.notifyClients("Nueva promoción: 50% en productos lacteos");
